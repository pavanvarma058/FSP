namespace _7_Cinema_Program_Revisited_Handling_Invalid_Input
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] movieList = { "The Imitation Game", "Ada", "Steve Jobs", "John Wick", "How to Train Your Dragon" };

            int[] ageRatings = { 12, 13, 15, 18, 10 };
